...
-- =====================================================
-- 7. TABLA: schedules (horarios por empleado y día)
-- =====================================================
CREATE TABLE IF NOT EXISTS schedules (
    id INT AUTO_INCREMENT PRIMARY KEY,

    employee_id INT NOT NULL COMMENT 'Empleado al que pertenece el horario',

    -- 1 = Lunes ... 7 = Domingo
    day_of_week TINYINT NOT NULL COMMENT '1=Lunes ... 7=Domingo',

    -- Horarios configurables
    entry_time      TIME DEFAULT NULL COMMENT 'Entrada a labores',
    lunch_out_time  TIME DEFAULT NULL COMMENT 'Salida a comer',
    lunch_in_time   TIME DEFAULT NULL COMMENT 'Entrada de comida',
    exit_time       TIME DEFAULT NULL COMMENT 'Salida de labores',
