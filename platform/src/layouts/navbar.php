...
$menuItems = [
  'perfil' => [
    ...
    'permission' => null // todos lo pueden ver
  ],
  'branches' => [
    'label' => 'Sucursales',
    ...
    'permission' => 'view_branches' // NUEVO
  ],
  'employees' => [
    'label' => 'Empleados',
    ...
    'permission' => 'view_employees' // NUEVO
  ],
  'vacaciones' => [
    'label' => 'Vacaciones',
    ...
    'permission' => null // todos lo pueden verr
  ],
  'logout' => [
    'label' => 'Cerrar Sesión',
    ...
    <div class="nav-wrapper">
      ...
      <div id="navMenu" class="dropdown-menu">
        <?php foreach ($menuItems as $item): ?>
          ...
          <?php
          // Si el elemento requiere permiso y el usuario NO lo tiene → saltar
