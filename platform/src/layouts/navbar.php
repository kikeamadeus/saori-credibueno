...
// ======================================================
// 1) Obtener datos del usuario desde sesión
// ======================================================
...
$menuItems = [
  ...
  'branches' => [
    ...
    'exclude' => [2, 4] // Auxiliar y empleado NO pueden verlo
  ],
  'employees' => [
    'label' => 'Empleados',
    ...
    <div class="nav-wrapper">
      ...
      <div id="navMenu" class="dropdown-menu">
        <?php foreach ($menuItems as $item): ?>
          <?php
          // Si el rol del usuario está en la lista de exclusiones, no mostrarlo
          if (isset($item['exclude']) && in_array($employeeRole, $item['exclude'])) {
            continue;
          }
          ?>
